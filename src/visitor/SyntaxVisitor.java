...
public class SyntaxVisitor implements Visitor<Element, Void> {
  ...
  @Override
  public Element visit(ForOperation forOperation, Void param) {
    Element el = this.xmlDocument.createElement("ForNode");
  ...
  @Override
  public Element visit(InitForOperation initForOperation, Void param) {
    String nameNode;
    Element el;
    if (initForOperation.getType() != null) {
      nameNode = "ForAssWithType";
      el = this.xmlDocument.createElement(nameNode);
      el.appendChild(initForOperation.getType().accept(this, param));
      el.appendChild(initForOperation.getId().accept(this, param));
      el.appendChild(initForOperation.getExpr().accept(this, param));
    } else if (initForOperation.getId() != null) {
      nameNode = "ForAssWithoutType";
      el = this.xmlDocument.createElement(nameNode);
      el.appendChild(initForOperation.getId().accept(this, param));
      el.appendChild(initForOperation.getExpr().accept(this, param));
    } else {
      nameNode = "ForAssEmpty";
      el = this.xmlDocument.createElement(nameNode);
    }
    return el;
  }
  ...
  @Override
  public Element visit(ExprForOperation exprForOperation, Void param) {
    String nameNode;
    Element el;
    if (exprForOperation.getExpr() != null) {
      nameNode = "ForWithExpr";
      el = this.xmlDocument.createElement(nameNode);
      el.appendChild(exprForOperation.getExpr().accept(this, param));
    } else {
      nameNode = "ForWithoutExpr";
      el = this.xmlDocument.createElement(nameNode);
    }
    return el;
  }
  ...
  @Override
  public Element visit(IncrForOperation incrForOperation, Void param) {
    String nameNode;
    Element el;
    if (incrForOperation.getId() != null && incrForOperation.getExpr() != null) {
      nameNode = "ForWithIncr";
      el = this.xmlDocument.createElement(nameNode);
      el.appendChild(incrForOperation.getId().accept(this, param));
      el.appendChild(incrForOperation.getExpr().accept(this, param));
    } else {
