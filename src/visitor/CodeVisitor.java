...
public class CodeVisitor implements Visitor<String, Scope> {
  ...
  public String visit(ForOperation forOperation, Scope param) {
    StringBuilder builder = new StringBuilder();
    builder.append("for (");
    String assOp = forOperation.getInitFor().accept(this, param).replace("\n", "") + "; ";
    String cond = forOperation.getExprFor().accept(this, param) + ";";
    String incr = forOperation.getIncrFor().accept(this, param).replace(";\n", "");
    builder.append(assOp);
    builder.append(cond);
    builder.append(incr);
    builder.append("){\n");
    String compState = forOperation.getBody().accept(this, param);
