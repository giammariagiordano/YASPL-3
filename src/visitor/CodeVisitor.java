...
public class CodeVisitor implements Visitor<String, Scope> {
  ...
  public String visit(RelopOperation relopOperation, Scope param) {
    ...
    if ((relopOperation.getLeftOperand().getNodeType() == ReturnType.STRING)
     ...
     // int addr = this.symbolTable.findAddr(relopOperation.getLeftOperand().accept(this, param));
  ...
  public String visit(ForOperation forOperation, Scope param) {
    this.symbolTable.setCurrentScope(forOperation.getAttachScope());
    StringBuilder builder = new StringBuilder();
    builder.append("for (");
    String assOp =
        forOperation.getInitFor().accept(this, forOperation.getAttachScope()).replace("\n", "")
            + "; ";
    String cond = forOperation.getExprFor().accept(this, forOperation.getAttachScope()) + ";";
    String incr =
        forOperation.getIncrFor().accept(this, forOperation.getAttachScope()).replace(";\n", "");
    builder.append(assOp);
    builder.append(cond);
    builder.append(incr);
    builder.append("){\n");
    String compState = forOperation.getBodyFor().accept(this, forOperation.getAttachScope());
  ...
  @Override
  public String visit(BodyNodeFor bodyFor, Scope param) {
    StringBuilder builder = new StringBuilder();
    bodyFor.getVarDecls().forEach(v -> {
      builder.append(v.accept(this, param));
    });
    bodyFor.getStatementsNode().forEach(s -> {
      builder.append(s.accept(this, param));
    });
    builder.toString();
    return builder.toString();
