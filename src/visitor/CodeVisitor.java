...
public class CodeVisitor implements Visitor<String, Scope> {
  ...
  public String visit(VarInitValueId varInitValueId, Scope param) {
   ...
   // int addr = this.symbolTable.findAddr(varInitValueId.getVarName().getName());
     ...
     * (varInitValueId.getVarName().getNodeType().getValue().equals("string")) {
     * builder.append(varInitValueId.getVarName().getName()+"=malloc(sizeof(char) * LENGTH);\n"); //
     * se ha un valore del tipo head string a = "ciao"; if (!initialValue.equals("")) {
     * builder.append( "strcpy(" + varInitValueId.getVarName().getName() + "," + initialValue +
     * ");\n"); } }
     */
    /*
     * if(!this.symbolTable.getCurrentScope().containsKey(addr) &&
     * varInitValueId.getVarName().getNodeType() == ReturnType.STRING) { mallocString
  ...
  @Override
  public String visit(ForOperation forOperation, Scope param) {
    StringBuilder builder = new StringBuilder();
    builder.append("for (");
    String assOp = forOperation.getInitFor().accept(this, forOperation.getAttachScope()).replace("\n", "") + "; ";
    String cond = forOperation.getExprFor().accept(this, forOperation.getAttachScope()) + ";";
    String incr = forOperation.getIncrFor().accept(this, forOperation.getAttachScope()).replace(";\n", "");
    builder.append(assOp);
    builder.append(cond);
    builder.append(incr);
    builder.append("){\n");
    String compState = forOperation.getBody().accept(this, forOperation.getAttachScope());
    builder.append(compState);
    builder.append("}\n");
    return builder.toString();
  }

  @Override
  public String visit(InitForOperation initForOperation, Scope param) {
    StringBuilder builder = new StringBuilder();
    if (initForOperation.getType() != null) {
      builder.append(initForOperation.getType().accept(this, param) + " ");
    }
    if (initForOperation.getId() != null && initForOperation.getExpr() != null) {
      builder.append(initForOperation.getId().accept(this, param));
      builder.append("=");

      builder.append(initForOperation.getExpr().accept(this, param));
    }
    return builder.toString();
  }

  @Override
  public String visit(ExprForOperation exprForOperation, Scope param) {
    StringBuilder builder = new StringBuilder();
    if (exprForOperation.getExpr() != null) {
      builder.append(exprForOperation.getExpr().accept(this, param));
    }
    return builder.toString();
  ...
  @Override
  public String visit(IncrForOperation incrForOperation, Scope param) {
    StringBuilder builder = new StringBuilder();
    if (incrForOperation.getId() != null && incrForOperation.getExpr() != null) {
      builder.append(incrForOperation.getId().accept(this, param));
      builder.append("=");
      builder.append(incrForOperation.getExpr().accept(this, param));
    }
    return builder.toString();
  }
